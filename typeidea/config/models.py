...
class SideBar(models.Model):
    ...
    def content_html(self) -> str:
        ...
        if self.display_type == self.DISPLAY_HTML:
            ...
            result = render_to_string('config/blocks/siderbar_posts.html', context=context)
            ...
            result = render_to_string('config/blocks/siderbar_comments.html', context=context)
        return result
